...
class simulationWorkflow:
	...
	def simulation_workflow(self,callbacks, ser):
	    #zephyr.configure_root_logger() don't want no logging file
	    ...
	    self.delayed_stream_thread = DelayedRealTimeStream(collector, callbacks, 1.2)
	    
	    self.protocol = BioHarnessProtocol(ser, [message_parser.parse_data])
	    self.protocol.enable_periodic_packets()
